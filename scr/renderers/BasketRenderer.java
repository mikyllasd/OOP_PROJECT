...
public class BasketRenderer {
    public static void draw(Graphics2D g, BasketSkin skin,
    ...
    private static void drawMetal(Graphics2D g, int x, int y, int w, int h) {
        ...
        g.setStroke(new BasicStroke(1.5f));
        g.drawPolygon(bx, by, 4);
        GradientPaint rim = new GradientPaint(x, 0, new Color(0x7A8A9A), x+w, 0, new Color(0xDCECF4));
        g.setPaint(rim);
    ...
    private static void drawGolden(Graphics2D g, int x, int y, int w, int h) {
        ...
        g.setStroke(new BasicStroke(1.5f));
        g.drawPolygon(bx, by, 4);
        GradientPaint rim = new GradientPaint(x, 0, new Color(0xC8960C), x+w/2, 0, new Color(0xFFE840));
        g.setPaint(rim);
        g.fillRoundRect(x-3, y-5, w+6, 10, 6, 6);
        g.setPaint(null);
        g.setColor(new Color(0xB8860B));
    ...
    private static void drawCart(Graphics2D g, int x, int y, int w, int h) {
        ...
        int[] wheelXs = {x+wheelR+4, x+w-wheelR-4};
        for (int wx : wheelXs) {
    ...
    private static void drawDiamond(Graphics2D g, int x, int y, int w, int h) {
        ...
        GradientPaint ice = new GradientPaint(x, y, new Color(0xC8EEFF), x+w, y+h, new Color(0x60A8D0));
        g.setPaint(ice);
        ...
        GradientPaint rim = new GradientPaint(x, 0, new Color(0x5898C8), x+w, 0, new Color(0xC8ECFF));
        g.setPaint(rim);
        g.fillRoundRect(x-3, y-5, w+6, 10, 5, 5);
        g.setPaint(null);
        g.setStroke(new BasicStroke(1f));
