...
public class Character extends Entity {
    ...
    public void draw(Graphics2D g) {
        ...
        if (animState == 1) drawY -= 8; // jump on catch
        if (animState == 2) drawY += (float)(Math.sin(animTimer * 0.8) * 4);
        ...
        g.fillRoundRect(nx - 3, (int)(drawY - 16), nw + 6, 14, 6, 6);
        g.setColor(new Color(60, 40, 20));
        g.drawString(name, nx, (int)(drawY - 4));
    }
